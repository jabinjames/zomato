import Gstore from '../../Images/icons/playstore.png';
import Appstore from '../../Images/icons/appstore.png';
import indianFlag from '../../Images/images/indiaflag.png';
...
import Youtube from '../../Images/images/youtube.png'
    ...
    return <div className={footerCss.footer}>
        <div className={footerCss.innerFooter}>
            <div className={footerCss.sec1}>
                <div className={footerCss.logoBox}>Somato</div>
            ...
            <div className={footerCss.sec3}>
                By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2022 © Tomato™ Ltd. 
                CLONE APP
                All rights reserved.
